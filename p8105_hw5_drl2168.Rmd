...
Since this appears to be working, I will now repeat the process, but allow the true mean to range from 0 to 6.
...
When the true mean is 0, the probability of rejecting the null hypothesis is very close to 0.05, our prescribed $\alpha$-level. When the true mean is not equal to 0, this probability is the power, or $1-\beta$. It is low for small effects (1,2), but is almost 100% by a mean of 4. The shape of this curve is sigmoidal, and crosses 50% a bit before 2, which would probably correspond to ~2 standard errors for these distributions $\frac{\sigma}{\sqrt{30}} \approx 1.82$.
